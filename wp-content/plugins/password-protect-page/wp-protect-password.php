...
$ppw_config = require_once PPW_DIR_PATH . 'config.php';

if ( $ppw_config->debug_mode ) {
	Puc_v4_Factory::buildUpdateChecker(
		'https://codewpress.com/internal-updates?action=get_metadata&slug=password-protect-page',
		__FILE__,
